...
// A GET request to scrape the DevTech website
app.get("/scrape", function (req, res) {

  console.log("Scrape in Routes reached.")

  // First, we grab the body of the html with request
  request("https://www.developer-tech.com/news/", function (error, response, html) {
    console.log('Getting Scrapes');
  ...
  res.send(alert("Scrape Complete"));
});
